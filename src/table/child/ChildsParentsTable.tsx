...
export default function ChildsParentsTable({child, childWithParents, setChildWithParents}: ChildsParentTableProps) {
    function deleteParentData(parent: ParentDataWithEmergencyContact) {
