...
import {useState, useRef, useCallback, type KeyboardEvent, FormEvent} from "react"
...
type AutoCompleteProps = {
    emptyMessage: string
    value?: ParentData
    onValueChange?: (value: ParentData) => void
    isLoading?: boolean
    disabled?: boolean
    placeholder?: string
}
...
export const AutoComplete = ({
    ...
    const [selected, setSelected] = useState<ParentData>(value as ParentData)
